...
const mockPdfParse = pdf_parse_1.default;
const mockMammoth = mammoth_1.default;
const MockedCompanyLookupService = companyLookup_1.CompanyLookupService;
const mockFs = fs;
describe('ResumeParser', () => {
    let resumeParser;
    let mockCompanyLookup;
    beforeEach(() => {
        // Clear all mocks
        jest.clearAllMocks();
        ...
        resumeParser = new resumeParser_1.ResumeParser();
    });
    describe('parseFile', () => {
      ...
      `;
            ...
            mockMammoth.extractRawText.mockResolvedValue({ value: mockDocxText });
            // Act
