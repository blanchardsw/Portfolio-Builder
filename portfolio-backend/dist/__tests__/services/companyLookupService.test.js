...
const companyLookup_1 = require("../../services/companyLookup");
// Mock axios to prevent actual network calls
jest.mock('axios');
const mockedAxios = require('axios');
describe('CompanyLookupService', () => {
    let companyLookupService;
    beforeEach(() => {
        companyLookupService = new companyLookup_1.CompanyLookupService();
        // Reset axios mocks
    ...
    describe('findCompanyWebsite', () => {
        ...
        it('should return company name only for null input', async () => {
            const result = await companyLookupService.findCompanyWebsite(null);
    ...
    describe('normalizeCompanyName', () => {
        it('should normalize company names correctly', () => {
            const service = companyLookupService; // Access private method
            const testCases = [
        ...
        it('should handle empty and whitespace strings', () => {
            const service = companyLookupService;
...
//# sourceMappingURL=companyLookupService.test.js.map