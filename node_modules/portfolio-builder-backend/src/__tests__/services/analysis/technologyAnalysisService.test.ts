import { TechnologyAnalysisService } from '../../../services/analysis/TechnologyAnalysisService';
import { WorkExperience } from '../../../types/portfolio';

describe('TechnologyAnalysisService', () => {
  let service: TechnologyAnalysisService;

  beforeEach(() => {
    service = new TechnologyAnalysisService();
  ...
  describe('extractTechnologiesFromExperience', () => {
    ...
    it('should handle work experience with undefined/null descriptions', () => {
      const workExperience: Partial<WorkExperience>[] = [
        ...
        { position: 'Engineer', description: null as any }
      ];
