...
class ResumeParser {
     ...
     */
    async enrichWithCompanyWebsitesFast(experiences) {
     ...
     */
    async enrichWithEducationWebsites(educationEntries) {
        ...
        const enrichedEducation = await Promise.all(educationEntries.map(async (edu) => {
